...
CREATE INDEX "index_settlements_on_client_id" ON "settlements" ("client_id");
CREATE INDEX "index_settlements_on_monthly_report_id" ON "settlements" ("monthly_report_id");
